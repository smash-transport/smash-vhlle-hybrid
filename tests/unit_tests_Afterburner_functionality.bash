...
function __static__Set_Events_Config_Key_For_SMASH_Or_FIST_And_Run_Consistency_Check()
{
...
{
    __static__Set_Events_Config_Key_For_SMASH_Or_FIST_And_Run_Consistency_Check
}
